...
class AsyncServiceHelper
{
            ...
            final LoaderCallbackInterface Callback)
    {
        ...
        if (AppContext.bindService(intent, helper.mServiceConnection,             Context.BIND_AUTO_CREATE)) {         return true;
        } else {         AppContext.unbindService(helper.mServiceConnection);
